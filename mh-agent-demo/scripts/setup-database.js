...
async function setupDatabase() {
  try {
    ...
    await pool.query(
      'INSERT INTO users (id, age, job, timezone, onboarding, notification_pref) VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT (id) DO UPDATE SET updated_at = CURRENT_TIMESTAMP',
    ...
    for (const signal of sensorData) {
      await pool.query(
        'INSERT INTO sensor_readings (user_id, source, payload, timestamp) VALUES ($1, $2, $3, $4) ON CONFLICT DO NOTHING',
    ...
    for (const log of userLogs) {
      await pool.query(
        'INSERT INTO user_logs (user_id, log_date, mood, flow, color, pain, nutrition) VALUES ($1, $2, $3, $4, $5, $6, $7) ON CONFLICT (user_id, log_date) DO NOTHING',
    ...
    for (const event of cycleEvents) {
      await pool.query(
        'INSERT INTO cycle_events (user_id, event_type, event_date) VALUES ($1, $2, $3) ON CONFLICT DO NOTHING',
